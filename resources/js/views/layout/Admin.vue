...
<div class="row mx-0">
    <aside class="sidebar-container col-12 col-lg-2 px-0">
        ...
        <ul class="sidebar-navigation">
            <li>
                <sidebar-link :href="'admin-posts'" :active="$route.name == 'admin-posts'">Posty</sidebar-link>
            </li>
          <!--  <li>
                <sidebar-link :href="'admin-categories'" :active="$route.name == 'admin-categories'">Kategorie</sidebar-link>
            </li> -->
            <li>
                <sidebar-link :href="'admin-static-sites'" :active="$route.name == 'admin-static-sites'">Strony Statyczne</sidebar-link>
            </li>
            <li>
