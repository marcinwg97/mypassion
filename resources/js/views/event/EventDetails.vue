    ...
    <div v-else class="container">
        <div class="row mx-0 py-3 post-detail">
            <div class="col-12 text-center">
                <h1 style="color: #2574A9">{{ event.title }}</h1>
            </div>
        ...
        <div class="col-12" v-if="isAddToEvent == false">
            <form class="col-12 col-lg-12" @submit.prevent="addNewUserToEvent"><button type="submit" class="btn btn-primary">Dołącz do wydarzenia</button></form>
        </div>
        <div class="col-12" v-else>
        <form class="col-12 col-lg-12" @submit.prevent="removeUserFromEvent"><button type="submit" class="btn btn-primary">Opuść wydarzenie</button></form>
        </div>
    </div>
  </main-layout>
</template>
