        ...
        <form class="col-12 col-lg-12" v-on:submit.prevent="editPost(post.id)">
            <div class="form-group row">
                ...
                <div class="form-group col-12">
                        ...
                        <div>
                            <input class="form-control" type="text" name="description_short" v-model="post.description_short" required>
                        </div>
                    </div>
                    <div class="form-group col-12">
                        <label for="seo_keywords" class="col-form-label">Keywords:</label>
                        <div>
                            <input class="form-control" type="text" name="seo_keywords" v-model="post.seo_keywords" required>
                        </div>
                    </div>
